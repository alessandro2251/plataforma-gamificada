...
// ============================================================================
// MICRO-COMPONENTE: Formulário reaproveitável (Criar/Editar Aula)
// ============================================================================
...
export function AdminManageSubjects() {
  const { subjects, addSubject, deleteSubject, deleteClassFromSubject } =
    useStudy();
  ...
  const onSubmitNewSubject = async (data) => {
    ...
    try {
      const newSubject = {
        title: data.title,
        description: data.description,
        prerequisiteId: data.requiresPrerequisite
              ...
              <div
                ...
                {isExpanded && (
                  <div className="p-5 pt-0 border-t border-vapor-border/30 bg-vapor-surface/30 rounded-b-xl animate-in slide-in-from-top-2">
                    ...
                    {/* Formulário de Edição (Abre logo abaixo da lista) */}
